    ...
    def task_inner_loop(inp, reuse=True,
      ...
      with tf.GradientTape(persistent=True) as g:
        for i in range(num_inner_updates):
          ...
          if self.learn_inner_update_lr:
            for block in range(NUM_DOWNCOV_BLOCKS):
              new_weights['encode_layer'+str(block)+'_'+'conv'][0] -= self.inner_update_lr_dict['encode_layer'+str(block)+'_'+'conv'][i][0]*gradients['encode_layer'+str(block)+'_'+'conv'][0]
              new_weights['encode_layer'+str(block)+'_'+'conv'][1] -= self.inner_update_lr_dict['encode_layer'+str(block)+'_'+'conv'][i][1]*gradients['encode_layer'+str(block)+'_'+'conv'][1]
              new_weights['encode_layer'+str(block)+'_'+'conv'][2] -= self.inner_update_lr_dict['encode_layer'+str(block)+'_'+'conv'][i][2]*gradients['encode_layer'+str(block)+'_'+'conv'][2]
              new_weights['encode_layer'+str(block)+'_'+'b'][0] -= self.inner_update_lr_dict['encode_layer'+str(block)+'_'+'b'][i][0]*gradients['encode_layer'+str(block)+'_'+'b'][0]
              new_weights['encode_layer'+str(block)+'_'+'b'][1] -= self.inner_update_lr_dict['encode_layer'+str(block)+'_'+'b'][i][1]*gradients['encode_layer'+str(block)+'_'+'b'][1]
              new_weights['encode_layer'+str(block)+'_'+'b'][2] -= self.inner_update_lr_dict['encode_layer'+str(block)+'_'+'b'][i][2]*gradients['encode_layer'+str(block)+'_'+'b'][2]
            for block in range(NUM_UPSAMPLING_BLOCKS):
              new_weights['decode_layer'+str(block)+'_'+'conv'][0] -= self.inner_update_lr_dict['decode_layer'+str(block)+'_'+'conv'][i][0]*gradients['decode_layer'+str(block)+'_'+'conv'][0]
              new_weights['decode_layer'+str(block)+'_'+'conv'][1] -= self.inner_update_lr_dict['decode_layer'+str(block)+'_'+'conv'][i][1]*gradients['decode_layer'+str(block)+'_'+'conv'][1]
              new_weights['decode_layer'+str(block)+'_'+'conv'][2] -= self.inner_update_lr_dict['decode_layer'+str(block)+'_'+'conv'][i][2]*gradients['decode_layer'+str(block)+'_'+'conv'][2]
              new_weights['decode_layer'+str(block)+'_'+'b'][0] -= self.inner_update_lr_dict['decode_layer'+str(block)+'_'+'b'][i][0]*gradients['decode_layer'+str(block)+'_'+'b'][0]
              new_weights['decode_layer'+str(block)+'_'+'b'][1] -= self.inner_update_lr_dict['decode_layer'+str(block)+'_'+'b'][i][1]*gradients['decode_layer'+str(block)+'_'+'b'][1]
              new_weights['decode_layer'+str(block)+'_'+'b'][2] -= self.inner_update_lr_dict['decode_layer'+str(block)+'_'+'b'][i][2]*gradients['decode_layer'+str(block)+'_'+'b'][2]
            new_weights['last_layer_conv'] -= self.inner_update_lr_dict['last_layer_conv'][i]*gradients['last_layer_conv']
            new_weights['last_layer_b'] -= self.inner_update_lr_dict['last_layer_b'][i]*gradients['last_layer_b']
          else:
            for block in range(NUM_DOWNCOV_BLOCKS):
              new_weights['encode_layer'+str(block)+'_'+'conv'][0] -= self.inner_update_lr*gradients['encode_layer'+str(block)+'_'+'conv'][0]
              new_weights['encode_layer'+str(block)+'_'+'conv'][1] -= self.inner_update_lr*gradients['encode_layer'+str(block)+'_'+'conv'][1]
              new_weights['encode_layer'+str(block)+'_'+'conv'][2] -= self.inner_update_lr*gradients['encode_layer'+str(block)+'_'+'conv'][2]
              new_weights['encode_layer'+str(block)+'_'+'b'][0] -= self.inner_update_lr*gradients['encode_layer'+str(block)+'_'+'b'][0]
              new_weights['encode_layer'+str(block)+'_'+'b'][1] -= self.inner_update_lr*gradients['encode_layer'+str(block)+'_'+'b'][1]
              new_weights['encode_layer'+str(block)+'_'+'b'][2] -= self.inner_update_lr*gradients['encode_layer'+str(block)+'_'+'b'][2]
            for block in range(NUM_UPSAMPLING_BLOCKS):
              new_weights['decode_layer'+str(block)+'_'+'conv'][0] -= self.inner_update_lr*gradients['decode_layer'+str(block)+'_'+'conv'][0]
              new_weights['decode_layer'+str(block)+'_'+'conv'][1] -= self.inner_update_lr*gradients['decode_layer'+str(block)+'_'+'conv'][1]
              new_weights['decode_layer'+str(block)+'_'+'conv'][2] -= self.inner_update_lr*gradients['decode_layer'+str(block)+'_'+'conv'][2]
              new_weights['decode_layer'+str(block)+'_'+'b'][0] -= self.inner_update_lr*gradients['decode_layer'+str(block)+'_'+'b'][0]
              new_weights['decode_layer'+str(block)+'_'+'b'][1] -= self.inner_update_lr*gradients['decode_layer'+str(block)+'_'+'b'][1]
              new_weights['decode_layer'+str(block)+'_'+'b'][2] -= self.inner_update_lr*gradients['decode_layer'+str(block)+'_'+'b'][2]
